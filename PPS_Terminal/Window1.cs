		...
		private void TimerWaitProcessor(object myObject, EventArgs myEventArgs)
		{
			...
			if (this.SelectIndex == 0)
			{
				...
				if (x == 6)
				{
                    ...
                    //this.Text.Text = "Республика Беларусь, 211188, Витебская обл., Лепельский р-н, п/о Домжерицы, ул. Центральная, 3\r\n\r\n Internet: www.berezinsky.com \n e-mail: tourism@berezinsky.com \r\n\n Директор ПРОКОШИН Андрей Михайлович \n тел: +375 21 322-64-00 \n Приёмная, секретарь САВИК Надежда Ивановна:\n тел: +375 21 322-63-44, факс: +375 21 322-63-42   \n Зам. директора по общим вопросам МОСКАЛЁВ Виктор Алексеевич\n тел.: +375 21 322-63-02 \n Зам. директора по научно-исследовательской работе ИВКОВИЧ Валерий Семёнович\n тел./факс: +375 21 322-63-43 \n Зам. директора по туризму ПРОКОШИНА Дина Михайловна\n  тел.: +375 21 322-64-06 \n Начальник эколого-туристического отдела ЯТЧЕНЯ Елена Николаевна \n тел.: +375 21 322-63-18 \n Начальник ГК СЕРГУЧ ВАСИЛЬЕВА Нина Ивановна\n тел.: +375 21 322-63-92 \n Администратор ГК СЕРГУЧ \n тел.: +375 21 322-63-00, +375 44 554-55-52 \n Начальник ГК ПЛАВНО МОРОЗ Сергей Васильевич\n тел.: +375 21 326-15-85 \n Администратор ГК ПЛАВНО  \n тел.: +375 21 32 6-15-84, +375 29 145-77-78 \n Администратор ГД НИВКИ \n тел.: +375 21 325-11-99, +375 29 145-77-75 \n И.о. главного бухгалтера НАГОРНАЯ Ольга Николаевна\n тел.: +375 21 322-63-55";
					this.RightInputGridLeft.Background = new SolidColorBrush(Color.FromArgb(0, 255, 255, 255));
			...
			else
			{
				...
				if (x == 0)
				{
					...
					if (y == 3)
					{
                        ...
                        //this.Text.Text = "- центральный аппарат управления;\r\n- 7 лесничеств заповедника;\r\n- ЭЛОХ «Барсуки», в состав которого входит 2 лесничества и 2 деревообрабатывающих цеха (ДОЦ)  «Барсуки» и «Березино»;\r\n- ДОЦ «Домжерицы»;\r\n - охотхозяйство «Березина»;\r\n- автотракторный парк;\r\n- гостиничные комплексы  «Плавно» и «Сергуч»;\r\n- дом экологического просвещения;\r\n- база отдыха «Нивки»Списочная численность работников 417 человека, в т.ч.  штат лесной охраны 176 человек. ";
						this.RightInputGrid.Background = new SolidColorBrush(Color.FromArgb(170, 255, 255, 255));
					}
				}
				if (x == 1)
